    ...
    if(fields[2] == "F"){
        ...
        for(int i = 0; i < tempCustomer -> getItemsOut().size(); i++){
            if(action.getVector(1) == tempCustomer -> getItemsOut(i)){
                borrowed = true;
            cout << "Account has already checked this item out" << endl;
                break;
            }
        }
        ...
        if(!borrowed){
            cout << "This item is not checked out to this account" << endl;
...
bool Store::borrowItem(){
    ...
    if(fields[2] == "F"){
        ...
        for(int i = 0; i < tempCustomer -> getItemsOut().size(); i++){
            ...
            if(action.getVector(1) == tempCustomer -> getItemsOut(i)){
                cout << "Account has already checked this comedy item out" << endl;
    ...
    //checks request for classic
        ...
        for(int i = 0; i < tempCustomer -> getItemsOut().size(); i++){
            if(action.getVector(1) == tempCustomer -> getItemsOut(i)){
                cout << "Account has already checked this classic item out" << endl;
